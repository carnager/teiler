...
install:
	...
	install -Dm644 uploader/s3 $(DESTDIR)$(PREFIX)/etc/teiler/uploader/s3
	install -Dm644 uploader/scp $(DESTDIR)$(PREFIX)/etc/teiler/uploader/scp
	install -Dm644 profiles/mp4-pulse $(DESTDIR)$(PREFIX)/etc/teiler/profiles/mp4-pulse
	install -Dm644 profiles/mp4-noaudio $(DESTDIR)$(PREFIX)/etc/teiler/profiles/mp4-noaudio
